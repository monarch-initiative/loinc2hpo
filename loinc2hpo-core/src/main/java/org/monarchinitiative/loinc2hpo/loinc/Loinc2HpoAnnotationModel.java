...
public class Loinc2HpoAnnotationModel {
    ...
    public static Map<LoincId, Loinc2HpoAnnotationModel> from_csv(String path) throws IOException, MalformedLoincCodeException {
        ...
        for (Loinc2HpoAnnotationCsvEntry entry : csvEntries){
            ...
            if (!annotationModelMap.containsKey(loincId)){
                Loinc2HpoAnnotationModel newModel = Loinc2HpoAnnotationModelBuilder.builder()
                        .withLoincId(loincId)
                        .withLoincScale(loincScale)
    ...
    public static final class Loinc2HpoAnnotationModelBuilder {
        private LoincId loincId;
        private LoincScale loincScale;
        private Map<Code, HpoTerm4TestOutcome> annotations;
        private LocalDateTime createdOn;
        ...
        private Loinc2HpoAnnotationModelBuilder() {
        }

        public static Loinc2HpoAnnotationModelBuilder builder() {
            return new Loinc2HpoAnnotationModelBuilder();
        }

        public Loinc2HpoAnnotationModelBuilder withLoincId(LoincId loincId) {
            this.loincId = loincId;
            return this;
        }

        public Loinc2HpoAnnotationModelBuilder withLoincScale(LoincScale loincScale) {
            this.loincScale = loincScale;
            return this;
        }

        public Loinc2HpoAnnotationModelBuilder withAnnotations(Map<Code, HpoTerm4TestOutcome> annotations) {
            this.annotations = annotations;
            return this;
        }

        public Loinc2HpoAnnotationModelBuilder withCreatedOn(LocalDateTime createdOn) {
            this.createdOn = createdOn;
            return this;
        }

        public Loinc2HpoAnnotationModelBuilder withCreatedBy(String createdBy) {
            this.createdBy = createdBy;
            return this;
        }

        public Loinc2HpoAnnotationModelBuilder withLastEditedOn(LocalDateTime lastEditedOn) {
            this.lastEditedOn = lastEditedOn;
            return this;
        }

        public Loinc2HpoAnnotationModelBuilder withLastEditedBy(String lastEditedBy) {
            this.lastEditedBy = lastEditedBy;
            return this;
        }

        public Loinc2HpoAnnotationModelBuilder withVersion(String version) {
            this.version = version;
            return this;
        }

        public Loinc2HpoAnnotationModelBuilder withIsFinalized(boolean isFinalized) {
            this.isFinalized = isFinalized;
            return this;
        }

        public Loinc2HpoAnnotationModelBuilder withComment(String comment) {
            this.comment = comment;
            return this;
        }
